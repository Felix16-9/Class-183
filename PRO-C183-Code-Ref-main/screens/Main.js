            ...
            <View style={styles.container}>
                ...
                <View style={styles.framesContainer}>
                    <ScrollView style={{ flexDirection: "row" }} horizontal showsHorizontalScrollIndicator={false}>
                        ...
                        <View>
                            <TouchableOpacity style={this.state.selected=='regular'}>
                            <Text> 
                                regular
                            </Text>
                            
                            </TouchableOpacity>
                            <TouchableOpacity style={this.state.selected=='wayfarer'}>
                                <Text>
                                    wayfarer
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={this.state.selected=='winless'}>
                                <Text>
                                    winless
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={this.state.selected=='round'}>
                                <Text>
                                    round
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={this.state.selected=='square'}>
                                <Text>
                                    square
                                </Text>
                            </TouchableOpacity>
